                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
                                        <tr>
                                            <td valign="top" class="preheaderContent" style="padding-top:10px; padding-right:20px; padding-bottom:10px; padding-left:20px;" mc:edit="preheader_content00">
                                                SHORTMESSAGEBODYGOESHERE
                                            </td>
                                            <td valign="top" width="180" class="preheaderContent" style="padding-top:10px; padding-right:20px; padding-bottom:10px; padding-left:0;" mc:edit="preheader_content01">					EMAILADDRESS
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                            	<a href="https://www.avidbrain.com" target="_blank">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                        <tr>
                                            <td valign="top" class="footerContent" mc:edit="footer_content00">
                                                ...
                                                <a href="https://www.facebook.com/avidbrain" target="_blank">Facebook</a>
                                                <a href="https://twitter.com/avidbrain" target="_blank">Twitter</a>
                                                <a href="https://www.linkedin.com/company/avidbrain/" target="_blank">LinkedIn</a>
                                                <a href="http://blog.avidbrain.com" target="_blank">Our Blog</a>
                                                
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top" class="footerContent" style="padding-top:0;" mc:edit="footer_content01">
                                                <em>Copyright &copy; THEDATE AvidBrain Inc., All rights reserved.</em>
                                                <br />
                                                <br />
