<?php
	...
	#$dependents->pagination->link_per_pagination = 15;
	...
	$includeme = array(
		$dependents->APP_PATH.'dependencies/functions/functions.php',
		$dependents->APP_PATH.'dependencies/classes/global.class.php',
		$dependents->APP_PATH.'dependencies/classes/mailgun.class.php',
		$dependents->APP_PATH.'dependencies/classes/database.class.php',
		$dependents->APP_PATH.'dependencies/classes/target.class.php',
		$dependents->APP_PATH.'dependencies/classes/user.class.php',
		$dependents->APP_PATH.'dependencies/classes/messaging.class.php',
		$dependents->APP_PATH.'dependencies/classes/sessions.class.php',
		$dependents->APP_PATH.'dependencies/classes/dualauth.class.php',
		$dependents->APP_PATH.'dependencies/classes/pagination.class.php',
		$dependents->APP_PATH.'dependencies/forms/form.class.php',
		$dependents->APP_PATH.'dependencies/phpfastcache/phpfastcache.php',
		$dependents->APP_PATH.'dependencies/middleware/csrfProtector.middleware.php',
		$dependents->APP_PATH.'dependencies/middleware/cipher.middleware.php'
	);
