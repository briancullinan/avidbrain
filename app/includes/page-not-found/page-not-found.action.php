<?php
	...
	$app->meta->keywords = 'avid, '.SITENAME_PROPPER.', brain, tutoring, tutor';
	$app->meta->description = 'avid brain tutoring, teach something, learn anything';

	$select = '
		settings.*,
		user.username,user.usertype,user.first_name,user.last_name,user.city,user.state_long,user.url,user.state_slug,user.city_slug,
