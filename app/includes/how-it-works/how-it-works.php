	...
	<div class="row">
		<div class="col s12 m4 l4">
			...
			<div class="howie-howitworks-img">
				<img class="responsive-img blue hide-on-small-only" src="/images/how-it-works/search.png" />
			</div>
		...
		<div class="col s12 m4 l4">
			...
			<div class="howie-howitworks-img">
				<img class="responsive-img blue darken-1 hide-on-small-only" src="/images/how-it-works/communicate.png" />
			</div>
		...
		<div class="col s12 m4 l4">
			...
			<div class="howie-howitworks-img">
				<img class="responsive-img blue darken-2 hide-on-small-only" src="/images/how-it-works/whytutor.png" />
			</div>
