<div class="attention-overlay">
	...
	<div class="container">
		...
		<p>Welcome to the new <?php echo SITENAME_PROPPER; ?> Profile.... From here you can edit your profile as you need.</p>
		
		<?php if($app->user->usertype=='tutor'): ?>		
			<div class="row">
				<div class="col s12 m6 l6">
					<p>Thank you for deciding to become a tutor with <?php echo SITENAME; ?>! In order to make sure you have the best experience tutoring with us we are going to walk you through how <?php echo SITENAME; ?> works. </p>
