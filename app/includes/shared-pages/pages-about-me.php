<?php if(isset($app->user->email) && $app->user->email == $app->currentuser->email): ?>
	...
	<?php else: ?>
		...
		<?php if(isset($app->currentuser->short_description_verified_status) && $app->currentuser->usertype=='tutor'): ?>
		...
		<?php if(isset($app->currentuser->personal_statement_verified_status) && $app->currentuser->usertype=='tutor'): ?>
			<div class="alert red white-text">
