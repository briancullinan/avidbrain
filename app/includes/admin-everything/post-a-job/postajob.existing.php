	...
	<div class="col s12 m3 l3">
		...
		<?php if(isset($app->thejob->applicants)): ?>
			<?php foreach($app->thejob->applicants as $applicants): ?>
				<div class="block">
					<div>
						<a target="_blank" href="<?php echo $applicants->url; ?>">
							<?php echo $applicants->first_name; ?> <?php echo $applicants->last_name; ?>
						</a>
					</div>
					<div>
						<?php echo $applicants->city; ?>, <?php echo $applicants->state; ?> <?php echo $applicants->zipcode; ?>
					</div>

					<div>$<?php echo $applicants->hourly_rate; ?>/Hour</div>
				</div>
			<?php endforeach; ?>
		<?php else: ?>
