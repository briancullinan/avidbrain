<?php
	if(isset($app->create)){
		...
		$app->mailgun->subject = 'Account Activation';
			$message = '<p>Welcome to '.$app->dependents->SITE_NAME_PROPPER.', please activate your profile by clicking the link below.</p>';
			$message.= '<p> Your password is: '.$app->create->password.' </p>';
			$message.= '<p> <a href="'.$app->dependents->DOMAIN.'/validate/'.$validation_code.'">Activate Account</a> </p>';
