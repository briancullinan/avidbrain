<?php
	...
	$data	=	$data->where($selec1.' = :myemail AND pending IS NULL AND payment_details = "Credit Card Error" ')->setParameter(':myemail',$app->user->email);
	...
	if(isset($data[0])){
		...
		$config = array(
			'total'    => $count,
			'url'      => '/sessions/broken-sessions/page',
			'page'     => $offsets->number,
	...
	$app->meta->title = 'Broken Sessions';