		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-6">
				<div class="form-group bank-details-inputs input-info">
					...
					<input class="form-control" type="text" placeholder="Please Enter Your Full Legal Name" id="full_legal_name" value="<?php echo $app->affiliate->first_name.' '.$app->affiliate->last_name; ?>" />
				</div>
			</div>
...
<form method="post" class="hide" id="bank_token" action="/affiliates/information">
