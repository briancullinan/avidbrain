		...
		<div class="col s12 m6 l6">
			...
			<div class="block">
				...
				<?php
					...
					$twitter = 'https://twitter.com/share?url='.$app->dependents->DOMAIN.'/student/'.$signupcode->promocode.'&text=I love @avidbrain Sign up with my promo code and get $'.$signupcode->value.' off your first tutoring session!';
				?>
