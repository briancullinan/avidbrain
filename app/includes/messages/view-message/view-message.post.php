<?php
	...
	if(isset($app->inboxaction->value)){
		...
		elseif($app->inboxaction->value=='flag'){
			...
			$app->connect->insert('avid___messages_spam',array('message_id'=>$id,'date'=>thedate(),'who_flagged'=>$app->user->email));
		...
		elseif($app->inboxaction->value=='un-flag'){
			...
			$app->connect->delete('avid___messages_spam',array('message_id'=>$id,'who_flagged'=>$app->user->email));
