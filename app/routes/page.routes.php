<?php
	...
	$routes['badges'] = (object)array('url'=>'/badges','slug'=>'badges','route'=>'/badges/','include'=>'badges','protected'=>NULL,'permissions'=>array(),'template'=>'ajax.badges.php','type'=>array('POST'));
	...
	$routes['payment-get-paid'] = (object)array('url'=>'/payment/get-paid','slug'=>'get-paid','route'=>'/payment/get-paid/','include'=>'payment/get-paid','protected'=>true,'permissions'=>array('tutor','student'));
	...
	$routes['affiliate-tools'] = (object)array('url'=>'/affiliate-tools','slug'=>'affiliate-tools','route'=>'/affiliate-tools/','include'=>'affiliates/affiliate-tools','protected'=>true,'permissions'=>array());
	$routes['affiliate-tools-download'] = (object)array('url'=>'/affiliate-tools/download','slug'=>'download','route'=>'/affiliate-tools/:download/','include'=>'affiliates/affiliate-tools/download','protected'=>true,'permissions'=>array());
	...
	if(isset($app->user->usertype) && $app->user->usertype=='admin'){
		...
		$routes['admin-signupdetails'] = (object)array('url'=>'/admin-everything/signupdetails','slug'=>'signupdetails','route'=>'/admin-everything/signupdetails/','include'=>'admin-everything/signupdetails','protected'=>true,'permissions'=>array('admin'));
		$routes['admin-signupdetails-page'] = (object)array('url'=>'/admin-everything/signupdetails','slug'=>'signupdetails','route'=>'/admin-everything/signupdetails/:page/','include'=>'admin-everything/signupdetails','protected'=>true,'permissions'=>array('admin'));
